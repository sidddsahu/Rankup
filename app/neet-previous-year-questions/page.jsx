...
//   return (
//     <main className="bg-gradient-to-b mt-16 from-white to-[#f5f9ff] min-h-screen">

//       {/* HERO */}
//       <section className="max-w-6xl mx-auto px-6 py-10">
//         <h1 className="text-4xl font-bold text-[#1E3A5F]">
//           NEET PYQs Chapter-wise PDFs
//         </h1>

//         <p className="mt-4 text-gray-600 max-w-2xl">
//           Download NEET previous year questions chapter-wise with
//           solutions. Practice smarter with subject filtering,
//           search and tracking.
//         </p>
//       </section>
...
//       {/* SEO HIDDEN */}
//       <p className="sr-only">
//         Download NEET previous year questions PDF chapter wise for Physics,
//         Chemistry and Biology. Free PYQs PDFs with solutions.
//       </p>

//       {/* CTA */}
//       <section className="text-center py-20">
//         <h2 className="text-2xl font-bold text-[#1E3A5F]">
//           Practice Daily. Improve Rank 🚀
//         </h2>
//       </section>
//     </main>
//   );
...
export const metadata = {
  title:
    "NEET Previous Year Questions (PYQs) Chapter-wise PDF 🔥 Free Download",
  description:
    "Download NEET previous year questions chapter-wise with solutions. Practice Physics, Chemistry, Biology PYQs with analysis and boost your NEET score.",
  keywords: [
    "neet pyq",
    "neet previous year questions",
    "neet pyq chapter wise pdf",
    "neet pyq download",
...
export default function Page() {
  const faqData = [
    {
      q: "Are NEET PYQs enough for preparation?",
      a: "Yes, PYQs are the most important resource but should be combined with NCERT and mock tests.",
    },
    {
      q: "How many years of NEET PYQs should I solve?",
      a: "You should solve at least 10–15 years of previous questions.",
    },
  ];
  ...
  return (
    <>
      ...
      <main className="bg-gradient-to-b from-white to-[#f5f9ff] min-h-screen">

        {/* HERO */}
        <section className="max-w-6xl mx-auto px-6 py-16">
          <h1 className="text-4xl font-bold text-[#1E3A5F]">
            NEET Previous Year Questions (PYQs) Chapter-wise
          </h1>

          <p className="mt-4 text-gray-600 max-w-2xl">
            Practice NEET previous year questions chapter-wise with solutions.
            Understand exam pattern, improve accuracy and boost your score 🚀
          </p>

          {/* Hidden SEO boost */}
          <p className="sr-only">
            NEET PYQ chapter wise PDF download for Physics, Chemistry and Biology with solutions and analysis.
          </p>
        </section>
        ...
        <section className="max-w-4xl mx-auto px-6 py-20 text-gray-700">
          <h2 className="text-2xl font-bold mb-4">
            NEET PYQ Chapter-wise Practice 2026
          </h2>

          <p className="mb-4">
            NEET previous year questions (PYQs) are the most reliable source for
            understanding exam trends. Many questions are directly repeated or
            slightly modified from previous years.
          </p>

          <p className="mb-4">
            Solving PYQs improves speed, accuracy and confidence. Focus on
            high-weightage chapters and practice regularly.
          </p>

          <ul className="list-disc pl-6 space-y-2">
            <li>Understand real NEET exam pattern</li>
            <li>Identify repeated concepts</li>
            <li>Improve accuracy and time management</li>
          </ul>
