  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "operatingSystem": "Android, iOS, Web",
        "description":
          "RankUp is a NEET online preparation app offering chapter-wise PYQs, NCERT based questions, smart revision tools, mock tests and performance analytics for NEET-UG students.",
        "offers": {
          "@type": "Offer",
          "price": "0",
          "priceCurrency": "INR"
  ...
  return (
    <>
      <header
        className="relative w-full py-16 overflow-hidden"
        role="banner"
        aria-label="RankUp NEET Online Preparation"
      >
        {/* Background Images */}
        <div className="absolute inset-0 -z-10">
          <Image
            src="/deepak2.webp"
            alt="RankUp NEET online preparation app preview on mobile"
            fill
            priority
            sizes="(max-width: 768px) 100vw, 600px"
            className="object-cover md:hidden"
          ...
          <Image
            src="/deepak3.webp"
            alt="RankUp NEET-UG app interface showing PYQs and revision tools"
            fill
            loading="lazy"
            sizes="(min-width: 769px) 50vw, 100vw"
            className="object-cover hidden md:block"
        ...
        <div className="relative z-10 max-w-5xl px-6 md:px-16 pt-24 md:pt-32 text-white">
          ...
          {/* 🔥 SEO POWER H1 */}
          <h1 className="mt-4 text-4xl md:text-4xl font-extrabold leading-tight">
            NEET Online Preparation with PYQs, NCERT Based Questions & Smart Revision
          </h1>

          {/* Subheading */}
          <p className="mt-4 text-lg text-purple-200 max-w-2xl">
            Chapter-wise NEET PYQs • Concept-wise Practice • Smart Analytics
            <br className="hidden md:block" />
            Everything you need to boost your NEET-UG rank faster.
          </p>

          {/* ✅ SEO MASTER LINK (ONLY ADDITION) */}
          <Link
            href="/neet-online-preparation"
            className="inline-block mt-4 text-purple-100 underline font-medium hover:text-white transition"
          >
            Complete NEET Online Preparation Guide (PYQs, Mock Tests & Revision)
          </Link>

          {/* Hidden SEO Content */}
          <p className="sr-only">
            RankUp is an online NEET preparation platform for NEET-UG students.
            Prepare with previous year questions, NCERT based practice,
            chapter-wise PYQs, mock tests, smart revision planner and performance analytics.
            Ideal for Class 11 and Class 12 NEET aspirants aiming for top ranks.
          </p>
          ...
          <div className="flex items-center gap-2 mt-8">
            <a
              href={playStore}
              aria-label="Download RankUp NEET preparation app free"
              className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 px-3 py-4 rounded-2xl font-semibold shadow-xl transition-all hover:-translate-y-1"
            >
              <FaGooglePlay className="text-xl" />
              Download FREE App
            ...
            <a
              href={appStore}
              aria-label="Download RankUp NEET app on Apple App Store"
              className="flex items-center gap-2 bg-white/10 border border-white/20 backdrop-blur-md px-3 py-4 rounded-2xl hover:bg-white/20 transition-all"
            >
              <FaApple className="text-xl" />
              App Store
