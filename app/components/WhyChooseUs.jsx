...
export default function WhyChooseUs() {
  ...
  return (
    <section className="relative py-20 overflow-hidden bg-[#1A365D] text-white" itemScope itemType="https://schema.org/WebPage">

      {/* Background Shapes */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute w-40 h-40 bg-white/20 rounded-xl rotate-12 top-10 left-10 blur-xl"></div>
        <div className="absolute w-56 h-56 bg-white/20 rounded-xl -rotate-6 bottom-16 right-16 blur-xl"></div>
        <div className="absolute w-24 h-24 bg-[#00B5D8]/30 rounded-xl rotate-12 bottom-10 left-1/4 blur-lg"></div>
        <div className="absolute w-32 h-32 bg-[#00B5D8]/30 rounded-xl rotate-45 top-24 right-1/4 blur-xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14" itemScope itemProp="mainEntity" itemType="https://schema.org/Article">
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight" itemProp="headline">
            Why Choose <span className="text-[#00D1FF]">RankUp</span> for NEET-UG?
          </h2>
          <p className="mt-4 text-lg text-gray-100" itemProp="description">
        ...
        <div className="grid md:grid-cols-3 gap-8" itemScope itemProp="mainEntity" itemType="https://schema.org/ItemList">
          ...
          {/* Card 1 */}
          <div className="p-8 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 hover:bg-white/30 transition-all duration-300 shadow-xl" itemScope itemProp="itemListElement" itemType="https://schema.org/ListItem">
            <div className="text-[#00D1FF] mb-4"><FaBrain size={42} aria-hidden="true" /></div>
            <h3 className="text-2xl font-bold mb-2" itemProp="name">Smart Flashcards</h3>
            <p className="text-gray-100 leading-relaxed" itemProp="description">
          ...
          {/* Card 2 */}
          <div className="p-8 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 hover:bg-white/30 transition-all duration-300 shadow-xl" itemScope itemProp="itemListElement" itemType="https://schema.org/ListItem">
            <div className="text-[#00D1FF] mb-4"><FaBookOpen size={42} aria-hidden="true" /></div>
          ...
          {/* Card 3 */}
          <div className="p-8 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 hover:bg-white/30 transition-all duration-300 shadow-xl" itemScope itemProp="itemListElement" itemType="https://schema.org/ListItem">
            <div className="text-[#00D1FF] mb-4"><FaChartLine size={42} aria-hidden="true" /></div>
        ...
        <div className="mt-16 p-8 rounded-2xl bg-white/20 border border-white/30 backdrop-blur-lg shadow-lg max-w-4xl mx-auto" itemScope itemType="https://schema.org/Article">
          <h3 className="text-3xl font-bold text-[#00D1FF] mb-4" itemProp="headline">
            Backed by Science
          </h3>
          <p className="text-gray-100 leading-relaxed" itemProp="description">
            Research from early 20th-century cognitive science shows that
            <strong className="font-semibold text-[#00D1FF] mx-1"> spaced repetition </strong>
            and
            <strong className="font-semibold text-[#00D1FF] mx-1"> active recall </strong>
